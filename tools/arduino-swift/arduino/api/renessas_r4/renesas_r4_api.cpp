// renesas_r4_api.cpp
// ArduinoSwift API extensions implementation for Arduino UNO R4 Minima (Renesas RA4M1).
//
// Base board layer ONLY:
// - Analog
// - External Interrupts (flag slots)
// - Serial printing
//
// No library knowledge here (no SSD1306Ascii, no user libs, etc).

#include <Arduino.h>
#include "renesas_r4_api.h"
